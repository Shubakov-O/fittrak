...
func (t Training) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	// ===== может быть косяк, не понял что сюда пихать
	info := InfoMessage{
...
func (r Running) Calories() float64 {
	// вставьте ваш код ниже
	rannCalories := ((CaloriesMeanSpeedMultiplier * r.meanSpeed() * CaloriesMeanSpeedShift) * r.Weight / MInKm * r.Duration.Hours() * MinInHours)
	return rannCalories
}
...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	speedKmSquare := math.Pow((w.meanSpeed() * KmHInMsec), 2)
	if w.Height == 0 {
		return 0
	}
	heightMetr := w.Height / CmInM
	walkCalories := ((CaloriesWeightMultiplier*w.Weight + (speedKmSquare/heightMetr)*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours)
	return walkCalories
}
...
func (s Swimming) Calories() float64 {
	// вставьте ваш код ниже
	swimmCalories := (s.meanSpeed() + SwimmingCaloriesMeanSpeedShift) * SwimmingCaloriesWeightMultiplier * s.Weight * s.Duration.Hours()
